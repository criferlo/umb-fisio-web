...
class Flash {
     ...
     */
    public static function show($name, $text, $icon) {
        if (isset($_SERVER['SERVER_SOFTWARE'])) {
            ...
            echo '<div class="', $name, '">
                ...
                ', "<i class='ace-icon fa fa-umbrella bigger-120 blue'></i>"." ".$text.'</div>', PHP_EOL;
        } else {
    ...
    public static function error($text) {
        return self::show('alert alert-block alert-danger', $text, 'icon-remove');
    }
    ...
    public static function warning($text) {
        return self::show('alert alert-block alert-warning', $text, '');
    }
    ...
    public static function info($text) {
        return self::show('alert alert-info', $text, '');
    }
    ...
    public static function valid($text) {
        return self::show('alert alert-block alert-success', $text, 'icon-ok');
    }
